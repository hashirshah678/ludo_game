...
export interface updataPlayerPieceValueProps {
    playerNo:number,
...
export interface GameInitialState{
    player1:Array<GameState>,
    player2:Array<GameState>,
    player3:Array<GameState>,
    player4:Array<GameState>,
    chancePlayer:number,
    diceNo:number,
